...
public:
  RBFM_ScanIterator() { test.pageNum = 0; test.slotNum = -1; };
  ~RBFM_ScanIterator() {};
...
//  RC getNextRecord(RID &rid, void *data) { return RBFM_EOF; };
  ...
  RC close();
  //{ RecordBasedFileManager *rbfm = RecordBasedFileManager::instance(); return rbfm->closeFile(fileHandle); };
};
...
public:
  ...
  RC insertRecord(FileHandle &fileHandle, const vector<Attribute> &recordDescriptor, const void *data, RID &rid, int mode=0);
